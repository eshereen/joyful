    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_count') ? 'is-invalid' : '' }}" type="number" name="item_count" id="item_count" value="{{ old('item_count', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_phone') ? 'is-invalid' : '' }}" type="text" name="shipping_phone" id="shipping_phone" value="{{ old('shipping_phone', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_name') ? 'is-invalid' : '' }}" type="text" name="shipping_name" id="shipping_name" value="{{ old('shipping_name', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('paid') ? 'is-invalid' : '' }}" name="paid" id="paid" required>
                    ...
                    @foreach(App\Models\Order::PAID_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('paid', 'unpaid') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('paid'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('shipped') ? 'is-invalid' : '' }}" name="shipped" id="shipped" required>
                    ...
                    @foreach(App\Models\Order::SHIPPED_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('shipped', 'pending') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
