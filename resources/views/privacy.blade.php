           ...
           <!--         <div class="flex w-full h-screen ">-->
               <div class="relative">
                ...
                <img src="{{asset('img/shapes/2.png')}}" alt="" width="300" class="z-0 hidden md:block md:absolute md:top-0 md:left-0 md:h-screen">
                    ...
                    <section class="container text-gray-700 body-font">
                            <div class="container px-8 py-16 mx-auto lg:px-4">
                                <div class="flex flex-col w-full px-10 mb-12 text-left lg:text-justify">

                                    <h1 class="mb-6 text-3xl font-semibold tracking-tighter text-center text-black sm:text-6xl title-font">
                                        Privacy Policy
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to joyful.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to joyful, accessible from <a href="http://joyfulegy.com/" rel="external nofollow noopener" target="_blank">http://joyfulegy.com/</a></p>
</li>
<li>
...
<ul>
<li>
<p>By email: info@joyfulegy.com</p>
</li>
<li>
<p>By visiting this page on our website: <a href="http://joyfulegy.com/" rel="external nofollow noopener" target="_blank">http://joyfulegy.com/</a></p>
</li>
</ul>
                    </div>
