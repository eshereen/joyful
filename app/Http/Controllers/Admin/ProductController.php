...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('categories', 'tags', 'sizes'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $product->load('categories', 'tags', 'size');

        return view('admin.products.edit', compact('categories', 'tags', 'sizes', 'product'));
    }
